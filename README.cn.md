...
- **最新版本**: `v0.37.1-rc.1` (2026-09-08)
- **最近提交**: 2026-09-02
- **Release 含资产**: 26 个

## 流行度

- **Star**: 11,298 · **Fork**: 598 · **开放 issue**: 763 · **贡献者**: 171

## 累计统计

- **发布数**: 701 · **已合并 PR**: 2924 · **开放 PR**: 50 · **已关闭 issue**: 653 · **开放 issue**: 110 · **提交数**: 4473
...
在 [repology.org](https://repology.org/project/vcluster) 上共有 **12** 个发行版报告此项目。**4** 个 ✅ 已是最新上游版本，**6** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:10:03Z._
